...
CCButton button[] = {
  {2, {MIDI_CC::General_Purpose_Controller_5, Channel_2}},
  {3, {MIDI_CC::General_Purpose_Controller_4, Channel_2}},
  {4, {MIDI_CC::General_Purpose_Controller_3, Channel_2}},
  {5, {MIDI_CC::General_Purpose_Controller_2, Channel_2}},
  {6, {MIDI_CC::General_Purpose_Controller_1, Channel_2}},
...
const int buttonPins[numButtons] = {6, 5, 4, 3, 2};
